...
def parse_args():
    ...
    parser.add_argument('--pretrain', type=str, default='/data/gwn/UNBERT/data/bert-base-uncased')
...
if __name__ == "__main__":
    ...
    # from src.miner import NewsEncoder
    ...
    # title_words = tokenizer.tokenize("How to report weather-related closings")
    # ids =  tokenizer.convert_tokens_to_ids(title_words)
    # print(ids)
    # print(tokenizer.cls_token_id)
    # encoding = tokenizer.encode("How to report weather-related closings")
    # print(encoding)
    pass